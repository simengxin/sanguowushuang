...
public class HighlightableObject : MonoBehaviour
{
	...
	public void FlashingOn(float freq)
	{
		...
		if (camera != null)
		{
			camera.SendMessage("OpenHighLight", true);
		}
	}
	...
	public void FlashingOff()
	{
		...
		if (camera != null)
		{
			camera.SendMessage("OpenHighLight", false);
		}
	}
